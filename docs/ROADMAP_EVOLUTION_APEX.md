...
| **2 — Dossiers** | Modifier/supprimer/réassigner une tâche + « Mes tâches » ✅ (0037) · Tableau fournisseurs (subvention acceptée, réclamé AUTO/manuel, source, total) ✅ · extraction de convention avec confirmation ✅ · tâches manuelles (urgente, responsable, description, réclamation liée) + origine visible ✅ · journal de dossier ✅ (statut, entente, documents, tâches, propositions) · facture ↔ réclamation (« Réclamé à ce jour » automatique), fournisseurs réordonnables, snapshot du programme à la création du dossier, notifications internes (cloche), journal enrichi ✅ (0038) · onglet « Échéanciers & tâches » du dossier : ajout manuel de tâches, d'échéances et de réclamations ; suppression de tout élément (manuel ou automatique, sans recréation par l'entente) ✅ (0040) · suppression d'un dossier entier (admin seulement, confirmation par nom exact, nettoyage du storage) ✅ · **restent** : gel du dossier déposé, exemple de DDR réutilisé pour les réclamations suivantes | ✅ majoritairement fait |
...
| **5 — Intelligence programme** | « Pose-moi tes questions » sourcé ✅ · aide à la rédaction : « Explique-moi ton projet » + compatibilité explicable ✅, budget intelligent (admissibilité d'une dépense, source vérifiée) ✅, documents à rassembler ✅ · projets comparables financés (exemples du programme, règle stricte) ✅ · import du questionnaire par texte collé + réponses proposées (sources vérifiées, confiance, informations manquantes, questions à poser) ✅ · copilote de rédaction (consigne libre, chiffres verrouillés, limite de longueur, vérifiée par le code) ✅ (0039) · **restent** : import direct d'un PDF/Word de questionnaire, versions des réponses, gel à la soumission, règles de programme versionnées, demande au client depuis le portail | ✅ largement fait (migrations 0037–0039) |
